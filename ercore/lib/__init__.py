# --- encoding: iso-8859-1 ---
#These are library functions for sea water properties

"""
Library functions for properties of sea water and other geophysical properties
...
from misc import freezept, soundvel, depth, pres
from suncalc import Sun
