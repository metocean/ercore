...
#Test 1 - Gas plume tank scale Chen and Yapa (2004)
  current=ConstantMover('vel',['u','v','w'],u=-0.1,v=0,w=0)
...
#Test 2 - Idealised gas plume
  ...
  current=ConstantMover('vel',['u','v','w'],u=0.16,v=0,w=0)
  tide=ConstantMover('vel',['u','v','w'],u=0.,v=0,w=0)
  ...
  Z0=-400
  GOR=5.345
  plume1=HCPlume('plume1',20000,is3d=True,movers=[mover],reactors=[temp,salt],diffusers=[diff],V0=numpy.array([0,0,V0]),P0=numpy.array([0,0,Z0]),T0=80,D0=893,db=0.006,B0=d,GOR=GOR,Mg=28.97e-3,Cpl=1.8,spwn=10,visc=0.033,IFT=0.02,wb=0.27,tstep=3600.)
  plume2=HCPlume('plume2',20000,is3d=True,movers=[mover],reactors=[temp,salt],diffusers=[diff],V0=numpy.array([0,0,V0]),P0=numpy.array([0,0,Z0]),T0=80,D0=893,db=0.006,B0=d,GOR=GOR,Mg=28.97e-3,Cpl=1.8,spwn=10,visc=0.033,IFT=0.02,wb=0.27,gsep=False)
elif test==3:
